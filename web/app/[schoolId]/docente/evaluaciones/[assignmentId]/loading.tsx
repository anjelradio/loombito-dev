...
export default function TeacherEvaluationsAssignmentLoading() {
  return (
    <>
      ...
      <ContentGridSurface variant="mist">
        ...
        <section className="grid gap-5 xl:grid-cols-[60%_40%]">
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-[#d8e5f5] bg-white p-5">
              <Skeleton className="h-48 w-full rounded-2xl bg-[#dbe8f5]" />
            </div>
          </div>
        </section>
      </ContentGridSurface>
